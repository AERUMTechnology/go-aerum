...
// Package accounts implements high level AERUMTechnology account management.
package accounts
...
// Account represents an AERUMTechnology account located at a specific location defined
// by the optional URL field.
type Account struct {
	Address common.Address `json:"address"` // AERUMTechnology account address derived from the key
...
type Wallet interface {
	...
	// chain state reader.
	SelfDerive(base DerivationPath, chain AERUMTechnology.ChainStateReader)
