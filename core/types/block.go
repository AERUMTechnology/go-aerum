...
// Package types contains data types related to AERUMTechnology consensus.
package types
...
// Header represents a block header in the AERUMTechnology blockchain.
type Header struct {
...
// Block represents an entire block in the AERUMTechnology blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// DecodeRLP decodes the AERUMTechnology
...
// EncodeRLP serializes b into the AERUMTechnology RLP block format.
