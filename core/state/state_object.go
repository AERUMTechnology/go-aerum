...
// stateObject represents an AERUMTechnology account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of AERUMTechnology address of the account
	data     Account
	db       *StateDB
...
// Account is the AERUMTechnology consensus representation of accounts.
