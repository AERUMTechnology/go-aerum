...
// Contains a wrapper for the AERUMTechnology client.
...
// AERUMTechnologyClient provides access to the AERUMTechnology APIs.
type AERUMTechnologyClient struct {
	client *ethclient.Client
}

// NewAERUMTechnologyClient connects a client to the given URL.
func NewAERUMTechnologyClient(rawurl string) (client *AERUMTechnologyClient, _ error) {
	rawClient, err := ethclient.Dial(rawurl)
	return &AERUMTechnologyClient{rawClient}, err
}

// GetBlockByHash returns the given full block.
func (ec *AERUMTechnologyClient) GetBlockByHash(ctx *Context, hash *Hash) (block *Block, _ error) {
...
func (ec *AERUMTechnologyClient) GetBlockByNumber(ctx *Context, number int64) (block *Block, _ error) {
	if number < 0 {
...
func (ec *AERUMTechnologyClient) GetHeaderByHash(ctx *Context, hash *Hash) (header *Header, _ error) {
...
func (ec *AERUMTechnologyClient) GetHeaderByNumber(ctx *Context, number int64) (header *Header, _ error) {
	if number < 0 {
...
func (ec *AERUMTechnologyClient) GetTransactionByHash(ctx *Context, hash *Hash) (tx *Transaction, _ error) {
...
func (ec *AERUMTechnologyClient) GetTransactionSender(ctx *Context, tx *Transaction, blockhash *Hash, index int) (sender *Address, _ error) {
...
func (ec *AERUMTechnologyClient) GetTransactionCount(ctx *Context, hash *Hash) (count int, _ error) {
...
func (ec *AERUMTechnologyClient) GetTransactionInBlock(ctx *Context, hash *Hash, index int) (tx *Transaction, _ error) {
...
func (ec *AERUMTechnologyClient) GetTransactionReceipt(ctx *Context, hash *Hash) (receipt *Receipt, _ error) {
...
func (ec *AERUMTechnologyClient) SyncProgress(ctx *Context) (progress *SyncProgress, _ error) {
...
func (ec *AERUMTechnologyClient) SubscribeNewHead(ctx *Context, handler NewHeadHandler, buffer int) (sub *Subscription, _ error) {
...
func (ec *AERUMTechnologyClient) GetBalanceAt(ctx *Context, account *Address, number int64) (balance *BigInt, _ error) {
	if number < 0 {
...
func (ec *AERUMTechnologyClient) GetStorageAt(ctx *Context, account *Address, key *Hash, number int64) (storage []byte, _ error) {
	if number < 0 {
...
func (ec *AERUMTechnologyClient) GetCodeAt(ctx *Context, account *Address, number int64) (code []byte, _ error) {
	if number < 0 {
...
func (ec *AERUMTechnologyClient) GetNonceAt(ctx *Context, account *Address, number int64) (nonce int64, _ error) {
	if number < 0 {
...
func (ec *AERUMTechnologyClient) FilterLogs(ctx *Context, query *FilterQuery) (logs *Logs, _ error) {
...
func (ec *AERUMTechnologyClient) SubscribeFilterLogs(ctx *Context, query *FilterQuery, handler FilterLogsHandler, buffer int) (sub *Subscription, _ error) {
	// Subscribe to the event internally
...
func (ec *AERUMTechnologyClient) GetPendingBalanceAt(ctx *Context, account *Address) (balance *BigInt, _ error) {
...
func (ec *AERUMTechnologyClient) GetPendingStorageAt(ctx *Context, account *Address, key *Hash) (storage []byte, _ error) {
...
func (ec *AERUMTechnologyClient) GetPendingCodeAt(ctx *Context, account *Address) (code []byte, _ error) {
...
func (ec *AERUMTechnologyClient) GetPendingNonceAt(ctx *Context, account *Address) (nonce int64, _ error) {
...
func (ec *AERUMTechnologyClient) GetPendingTransactionCount(ctx *Context) (count int, _ error) {
...
func (ec *AERUMTechnologyClient) CallContract(ctx *Context, msg *CallMsg, number int64) (output []byte, _ error) {
	if number < 0 {
...
func (ec *AERUMTechnologyClient) PendingCallContract(ctx *Context, msg *CallMsg) (output []byte, _ error) {
	return ec.client.PendingCallContract(ctx.context, msg.msg)
}

// SuggestGasPrice retrieves the currently suggested gas price to allow a timely
// execution of a transaction.
func (ec *AERUMTechnologyClient) SuggestGasPrice(ctx *Context) (price *BigInt, _ error) {
...
func (ec *AERUMTechnologyClient) EstimateGas(ctx *Context, msg *CallMsg) (gas int64, _ error) {
...
func (ec *AERUMTechnologyClient) SendTransaction(ctx *Context, tx *Transaction) error {
