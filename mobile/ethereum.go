...
// Contains all the wrappers from the go-aerum-new root package.
...
type Subscription struct {
	sub AERUMTechnology.Subscription
}
...
// the AERUMTechnology network.
type SyncProgress struct {
	progress AERUMTechnology.SyncProgress
}
...
type FilterQuery struct {
	query AERUMTechnology.FilterQuery
}
