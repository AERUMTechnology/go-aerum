...
// MainnetGenesis returns the JSON spec to use for the main AERUMTechnology network. It
// is actually empty since that defaults to the hard coded binary genesis block.
func MainnetGenesis() string {
	return ""
}

// TestnetGenesis returns the JSON spec to use for the AERUMTechnology test network.
