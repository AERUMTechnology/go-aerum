...
var (
	...
	// Added by Aerum. This seems to be used only in genesis.go so we may not need it. Consider to remove later
	// AtmosChainConfig contains the chain parameters to run a node on the Aerum network.
	...
	// and accepted by the AERUMTechnology core developers into the Ethash consensus.
	//
	...
	// and accepted by the AERUMTechnology core developers into the Clique consensus.
	//
	// This configuration is intentionally not using keyed fields to force anyone
	// adding flags to the config to also have to set these fields.
...
type ChainConfig struct {
	...
	// EIP150 implements the Gas price changes (https://github.com/AERUMTechnology/EIPs/issues/150)
