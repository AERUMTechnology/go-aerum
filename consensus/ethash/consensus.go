...
// stock AERUMTechnology ethash engine.
...
// rules of the stock AERUMTechnology ethash engine.
...
func calcDifficultyByzantium(time uint64, parent *types.Header) *big.Int {
	// https://github.com/AERUMTechnology/EIPs/issues/100.
	// algorithm:
	// diff = (parent_diff +
	...
	// https://github.com/AERUMTechnology/EIPs/pull/669
...
func calcDifficultyHomestead(time uint64, parent *types.Header) *big.Int {
	// https://github.com/AERUMTechnology/EIPs/blob/master/EIPS/eip-2.md
	// algorithm:
	// diff = (parent_diff +
