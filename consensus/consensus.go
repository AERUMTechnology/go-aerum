...
// Package consensus implements different AERUMTechnology consensus engines.
package consensus
...
type Engine interface {
	// Author retrieves the AERUMTechnology address of the account that minted the given
