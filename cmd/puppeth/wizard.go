...
type wizard struct {
	...
	services map[string][]string   // AERUMTechnology services known to be running on servers
...
// it to an AERUMTechnology address.
...
// converts it to an AERUMTechnology address. If an empty line is entered, the default
// value is returned.
