...
// setting up a new or managing an existing AERUMTechnology private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your AERUMTechnology private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new AERUMTechnology network down to  |")
	...
	log.Info("Administering AERUMTechnology network", "name", w.network)
