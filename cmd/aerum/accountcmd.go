...
var (
	walletCommand = cli.Command{
		Name:      "wallet",
		Usage:     "Manage AERUMTechnology presale wallets",
		ArgsUsage: "",
		Category:  "ACCOUNT COMMANDS",
		Description: `
    aerum wallet import /path/to/my/presale.wallet
		...
		Subcommands: []cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import AERUMTechnology presale wallet",
				ArgsUsage: "<keyFile>",
				...
				Description: `
	aerum wallet [options] /path/to/my/presale.wallet
...
between AERUMTechnology nodes by simply copying.
...
For non-interactive use the passphrase can be specified with the --password flag:
    ...
    aerum account update [options] <address>
...
For non-interactive use the passphrase can be specified with the -password flag:
    ...
    aerum account import [options] <keyfile>

Note:
As you can directly copy your encrypted accounts to another AERUMTechnology instance,
