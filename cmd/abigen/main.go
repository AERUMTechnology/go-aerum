...
import (
	...
	"github.com/AERUMTechnology/go-aerum-new/common/compiler"
)

var (
	abiFlag = flag.String("abi", "", "Path to the AERUMTechnology contract ABI json to bind, - for STDIN")
	binFlag = flag.String("bin", "", "Path to the AERUMTechnology contract bytecode (generate deploy method)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the AERUMTechnology contract Solidity source to build and bind")
