...
/*
Package node sets up multi-protocol AERUMTechnology nodes.
...
Node also creates the shared store of encrypted AERUMTechnology account keys. Services can access
