...
We want to build go-aerum-new with the most recent version of Go, irrespective of the Go
...
can be edited at https://launchpad.net/%7EAERUMTechnology/+archive/ubuntu/AERUMTechnology/+edit-dependencies
...
Then go into the source package directory for your running distribution and build the package:
    ...
    $ cd dist/AERUMTechnology-unstable-1.6.0+xenial
    $ dpkg-buildpackage
