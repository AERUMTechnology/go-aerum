...
Section "Geth" GETH_IDX
  ...
  # Firewall - add rules
  SimpleFC::AdvAddRule "Geth incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "AERUMTechnology" 30303 "" "" ""
  SimpleFC::AdvAddRule "Geth outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "AERUMTechnology" "" 30303 "" ""
  SimpleFC::AdvAddRule "Geth UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "AERUMTechnology" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/AERUMTechnology/EIPs/issues/147)
  ${EnvVarUpdate} $0 "AERUMTechnology_SOCKET" "R" "HKLM" "\\.\pipe\aerum.ipc"
  ${EnvVarUpdate} $0 "AERUMTechnology_SOCKET" "A" "HKLM" "\\.\pipe\aerum.ipc"
