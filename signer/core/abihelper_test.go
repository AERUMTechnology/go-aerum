...
func TestNewUnpacker(t *testing.T) {
	...
	testcases := []unpackTest{
		...
		}, { // https://github.com/AERUMTechnology/wiki/wiki/AERUMTechnology-Contract-ABI#examples
...
[
	...
	for _, hexdata := range []string{
		...
		// From https://github.com/AERUMTechnology/wiki/wiki/AERUMTechnology-Contract-ABI
