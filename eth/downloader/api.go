...
// Syncing provides information when this nodes starts synchronising with the AERUMTechnology network and when it's finished.
...
type SyncingResult struct {
	...
	Status  AERUMTechnology.SyncProgress `json:"status"`
}
