...
see https://github.com/AERUMTechnology/go-aerum-new/issues/2040
Usage:

import (
 "github.com/AERUMTechnology/go-aerum-new/common/httpclient"
 "github.com/AERUMTechnology/go-aerum-new/swarm/api/http"
)
