...
// Service implements an AERUMTechnology netstats reporting daemon that pushes local
// chain statistics up to a monitoring server.
type Service struct {
	server *p2p.Server        // Peer-to-peer server to retrieve networking infos
	eth    *eth.AERUMTechnology      // Full AERUMTechnology service if monitoring a full node
	les    *les.LightAERUMTechnology // Light AERUMTechnology service if monitoring a light node
...
func New(url string, ethServ *eth.AERUMTechnology, lesServ *les.LightAERUMTechnology) (*Service, error) {
