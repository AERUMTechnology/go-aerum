...
// Whisper represents a dark communication interface through the AERUMTechnology
...
// New creates a Whisper client ready to communicate through the AERUMTechnology P2P network.
